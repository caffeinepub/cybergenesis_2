      ...
      <CardContent className="space-y-4">
          ...
          <div className="mt-6 p-4 bg-green-500/10 border border-green-500/30 rounded-lg">
            ...
            <div className="mt-3 p-3 bg-black/30 rounded border border-cyan-500/20">
              <p className="text-xs text-gray-400 mb-2">
                Для финальной валидации выполните:
              </p>
        ...
        <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
          ...
          <div className="space-y-2 text-sm text-gray-300">
            <p>
              <strong className="text-white">Land Canister:</strong> Основной
              backend канистр для управления землями
            </p>
            <p>
              <strong className="text-white">Cyber Token Canister:</strong>{" "}
              ICRC-1 токен канистр (CBR)
            </p>
            <p>
              <strong className="text-white">Asset Canister:</strong> Хранилище
              3D моделей и ассетов
            </p>
            <p>
              <strong className="text-white">Marketplace Canister:</strong> P2P
              торговая площадка
            </p>
            <p>
              <strong className="text-white">Governance Canister:</strong> DAO
