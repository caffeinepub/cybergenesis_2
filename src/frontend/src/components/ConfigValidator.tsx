...
// Hardcoded fallback IDs used when env vars are not set (Caffeine deployment)
const FALLBACK_LAND_ID = "br5f7-7uaaa-aaaaa-qaaca-cai";
const FALLBACK_ASSET_ID = "bd3sg-teaaa-aaaaa-qaaba-cai";
...
function validateEnvironment(): ValidationResult {
  ...
  // Check for Land Canister ID — accept env var, Caffeine-injected var, or hardcoded fallback
  ...
  // Check for Asset Canister ID — same fallback logic
  ...
  // Check for Token Canister ID (optional — warning only)
  ...
  // Network: treat missing as "ic" (Caffeine always deploys to mainnet)
